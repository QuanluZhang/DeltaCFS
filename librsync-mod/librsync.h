...
typedef struct MD_context_tmp md_context;
...
void            md5_begin(/* @out@ */ md_context * md);
...
rs_job_t *rs_loadsig_begin(rs_signature_t **, FILE *);
...
rs_result rs_loadsig_file(FILE *, rs_signature_t **, rs_stats_t *, FILE *old_file);
